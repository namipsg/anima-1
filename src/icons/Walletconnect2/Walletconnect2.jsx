...
export const Walletconnect2 = ({ className }) => {
  return (
    <svg
      className={`walletconnect-2 ${className}`}
      fill="none"
      height="32"
      viewBox="0 0 32 32"
      width="32"
    ...
    >
      <g className="g" clipPath="url(#clip0_2502_8415)">
        <path
          className="path"
          d="M16 32C24.8366 32 32 24.8366 32 16C32 7.16344 24.8366 0 16 0C7.16344 0 0 7.16344 0 16C0 24.8366 7.16344 32 16 32Z"
          fill="url(#paint0_radial_2502_8415)"
        />
        <path
          className="path"
