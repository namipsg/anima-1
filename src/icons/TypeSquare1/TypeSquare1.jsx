...
export const TypeSquare1 = ({ className }) => {
  return (
    <svg
      className={`type-square-1 ${className}`}
      fill="none"
      height="128"
      viewBox="0 0 128 128"
      width="128"
    ...
    >
      ...
      <defs className="defs">
        <radialGradient
          ...
          cx="0"
          cy="0"
          gradientTransform="translate(0.000396729 64.002) scale(128)"
          gradientUnits="userSpaceOnUse"
          id="paint0_radial_1950_3520"
          r="1"
        >
          <stop className="stop" stopColor="#5D9DF6" />
          <stop className="stop" offset="1" stopColor="#006FFF" />
        </radialGradient>
        <clipPath className="clip-path" id="clip0_1950_3520">
